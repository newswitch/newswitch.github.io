...
| --- | --- |
| [概述](./01-概述.md) | 存储系统总览 |
| [配置与密文管理](./02-配置与密文管理.md) | ConfigMap / Secret 总述 |
| [ConfigMap](./03-ConfigMap.md) | 配置数据 |
| [Secret](./04-Secret.md) | 敏感数据 |
| [ConfigMap 热更新](./05-ConfigMap热更新.md) | 配置热更新 |
| [Volume](./06-Volume.md) | 卷类型 |
| [持久化卷](./07-持久化卷.md) | PV / PVC |
| [Storage Class](./08-StorageClass.md) | 动态供给 |
| [本地持久化存储](./09-本地持久化存储.md) | Local PV |
