...
## 1. StorageClass 概述 {/* #storageclass-概述 */}
...
## 2. StorageClass 资源定义 {/* #storageclass-资源定义 */}
...
### 4.1 回收策略（reclaimPolicy） {/* #回收策略reclaimpolicy */}
...
### 4.2 卷绑定模式（volumeBindingMode） {/* #卷绑定模式volumebindingmode */}
...
## 5. 默认 StorageClass {/* #默认-storageclass */}
...
### 6.1 创建 StorageClass {/* #创建-storageclass */}
