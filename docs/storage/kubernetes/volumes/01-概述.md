...
sidebar_label: "01. Kubernetes 存储系统概览"
sidebar_position: 1
...
![存储系统架构图](/images/k8s/storage/overview/49c40e82a0ff701c4d4148baa8a45de0.svg)

Kubernetes 存储系统由控制面、节点组件、存储资源和外部插件等部分组成，共同实现持久化存储的全生命周期管理。

## 2. 核心存储概念 {/* #核心存储概念 */}

### 2.1 卷（Volume） {/* #卷volume */}
...
![Pod 与卷挂载关系](/images/k8s/storage/overview/85a981156d5b686de666cdee2a97b54a.svg)
...
### 2.2 持久卷与声明（PV & PVC） {/* #持久卷与声明pv--pvc */}
...
![PV/PVC 绑定与类型关系](/images/k8s/storage/overview/7b4b9d492e671d5f1800fc59c26491e2.svg)
...
### 3.1 StorageClass（存储类） {/* #storageclass存储类 */}
...
![StorageClass 关系图](/images/k8s/storage/overview/9cf3303700437b08cde53d2fd6548825.svg)
...
![卷快照资源关系](/images/k8s/storage/overview/458f2b51759cc12c6b58fc7ea1042d8b.svg)
...
![CSI 组件交互图](/images/k8s/storage/overview/8d9718fcf39c658785256b6ae13d9c96.svg)
...
## 6. 临时卷（Ephemeral Volumes） {/* #临时卷ephemeral-volumes */}
...
![临时卷生命周期](/images/k8s/storage/overview/1601cd8817ec8421057d4f07aeb3caf2.svg)
...
![持久存储生命周期流程](/images/k8s/storage/overview/81da2dad9c0a36f352cd37c70bd041fa.svg)
