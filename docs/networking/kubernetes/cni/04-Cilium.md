...
sidebar_label: "04. 基于 eBPF 的网络 Cilium"
sidebar_position: 4
...
## 2. Hubble：网络可观测性平台 {/* #hubble网络可观测性平台 */}

Hubble 是 Cilium 的网络可观测性组件，提供对 Kubernetes 集群网络流量的深度可视化和监控。

### 2.1 Hubble 的核心功能 {/* #hubble-的核心功能 */}
...
## 4. 网络模型与部署模式 {/* #网络模型与部署模式 */}

Cilium 支持多种网络模型，适应不同基础设施和性能需求。

### 4.1 Overlay 网络模式 {/* #overlay-网络模式 */}
...
### 4.2 Native Routing 模式 {/* #native-routing-模式 */}
...
### 5.2 Cilium Operator {/* #cilium-operator */}
