...
sidebar_label: "01. Kubernetes 中的服务发现与网络路由"
sidebar_position: 1
...
![Service 层次结构与访问流程](/images/k8s/service-discovery/overview/c7a47cb31c775199d3f79a9bc48ea56c.svg)

## 2. Service 类型 {/* #service-类型 */}
...
![不同 Service 类型流量路径](/images/k8s/service-discovery/overview/a02b613568d9af5144190b6b698d7135.svg)

## 3. Service 选择器与端点 {/* #service-选择器与端点 */}

Service 通过标签选择器确定后端 Pod，Kubernetes 自动生成 EndpointSlice 记录所有匹配 Pod 的 IP。无选择器的 Service 可手动管理 EndpointSlice。

## 4. 多端口与 Headless Service {/* #多端口与-headless-service */}
...
![普通 Service 与 Headless Service 对比](/images/k8s/service-discovery/overview/64fddc9b958a9bf4118da8ed32064302.svg)

## 5. EndpointSlice 机制 {/* #endpointslice-机制 */}
...
![Kubernetes DNS 解析流程](/images/k8s/service-discovery/overview/c07a80c96558caa732a2081f305c29db.svg)

### 6.3 Pod DNS 配置 {/* #pod-dns-配置 */}
...
![Ingress 流量路由示意](/images/k8s/service-discovery/overview/2e53647a7d69fc6c6eac81eaae283566.svg)
...
## 8. 网络策略（NetworkPolicy） {/* #网络策略networkpolicy */}
...
![NetworkPolicy 流量控制示意](/images/k8s/service-discovery/overview/12fb2634fbc2a086005dda8185e71931.svg)
...
![双栈网络配置与流量](/images/k8s/service-discovery/overview/03a588dd8d97f0c8ac83d34a0953b2dd.svg)
...
## 10. Service 内部流量策略 {/* #service-内部流量策略 */}
...
3. [Kubernetes NetworkPolicy 官方文档 - kubernetes.io](../security/04-NetworkPolicy.md)
