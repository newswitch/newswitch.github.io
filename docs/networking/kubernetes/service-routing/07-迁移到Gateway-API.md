...
## 2. 为什么要切换到 Gateway API {/* #为什么要切换到-gateway-api */}

在正式迁移前，建议先了解 Ingress API 的局限性及 Gateway API 的优势。

### 2.1 Ingress API 的局限性 {/* #ingress-api-的局限性 */}
...
### 2.2 Gateway API 的优势 {/* #gateway-api-的优势 */}
...
## 3. Ingress API 与 Gateway API 的核心差异 {/* #ingress-api-与-gateway-api-的核心差异 */}
...
#### 5.2.1 分析现有 Ingress 配置 {/* #分析现有-ingress-配置 */}
...
#### 5.2.2 创建 GatewayClass {/* #创建-gatewayclass */}
...
#### 5.2.3 定义 Gateway 资源 {/* #定义-gateway-资源 */}
...
#### 5.2.4 创建 HTTPRoute 资源 {/* #创建-httproute-资源 */}
