...
Gateway API 作为替代 [Ingress](./04-Ingress.md) 的下一代资源，既可以处理南北向流量，还可以处理东西向流量。关于 Gateway API 的详细介绍和发展趋势，请参考 [Gateway API：Kubernetes 和服务网格入口中网关的未来](https://jimmysong.io/zh/blog/why-gateway-api-is-the-future-of-ingress-and-mesh/)。
