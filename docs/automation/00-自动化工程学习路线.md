...
sidebar_position: 0
description: "从 Ansible 配置管理、可测试的 Python CLI、Kubernetes 与 Prometheus API 开始，逐步学习 Go 并发、client-go Controller，并完成可审计的生产自动化项目。"
tags: [自动化, Ansible, Python, Go, Kubernetes, client-go, SRE, 学习路线]
---
...
```mermaid
flowchart LR
    E["Ansible<br/>批量配置与受控发布"] --> D["生产自动化项目"]
...
| 顺序 | 文章 | 完成后能做什么 |
| --- | --- | --- |
| 00 | [Ansible 从零到精通学习路线](./ansible/00-Ansible从零到精通学习路线.md) | 掌握 Inventory、Playbook、Role、Vault、滚动发布、测试、AWX、性能和故障排查 |
