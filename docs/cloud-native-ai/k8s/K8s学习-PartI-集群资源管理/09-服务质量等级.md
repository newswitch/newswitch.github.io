...
:::info 转载说明
本文整理自 [Jimmy Song《Kubernetes 教程》](https://jimmysong.io/zh/book/kubernetes-handbook/) 对应章节，原文采用 [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh) 协议。原作者：Jimmy Song；原页：[服务质量等级（QoS）](https://jimmysong.io/zh/book/kubernetes-handbook/cluster/qos/)。仅供个人非商业学习；若有勘误请以上游为准。
:::
