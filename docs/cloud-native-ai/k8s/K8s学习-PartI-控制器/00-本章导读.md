...
| --- | --- |
| [概述](./概述) | 工作负载与控制器总览 |
| [Deployment](./Deployment) | 无状态应用 |
| [StatefulSet](./StatefulSet) | 有状态应用 |
| [DaemonSet](./DaemonSet) | 每节点一份 |
| [ReplicationController 和 ReplicaSet](./ReplicationController与ReplicaSet) | 副本控制器 |
| [Job](./Job) | 批处理 |
| [CronJob](./CronJob) | 定时任务 |
| [Ingress 控制器](./Ingress控制器) | 入口控制器 |
| [HPA](./HPA) | 水平自动扩缩 |
| [准入控制器](./准入控制器) | Admission Controller |
