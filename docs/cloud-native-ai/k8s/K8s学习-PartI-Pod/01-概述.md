...
| 控制器类型 | 用途 | 特点 |
|------------|------|------|
| [Deployment](/docs/cloud-native-ai/k8s/K8s学习-PartI-控制器/Deployment) | 无状态应用 | 副本管理、滚动更新 |
| [StatefulSet](/docs/cloud-native-ai/k8s/K8s学习-PartI-控制器/StatefulSet) | 有状态应用 | 有序部署、持久化存储 |
| [DaemonSet](/docs/cloud-native-ai/k8s/K8s学习-PartI-控制器/DaemonSet) | 节点级服务 | 每个节点运行一个 Pod |
| [Job](/docs/cloud-native-ai/k8s/K8s学习-PartI-控制器/Job) | 批处理任务 | 一次性任务执行 |
| [CronJob](/docs/cloud-native-ai/k8s/K8s学习-PartI-控制器/CronJob) | 定时任务 | 按计划执行任务 |
