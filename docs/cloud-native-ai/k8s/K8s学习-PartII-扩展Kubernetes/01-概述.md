...
1. [API 扩展机制](/docs/cloud-native-ai/k8s/K8s学习-PartII-扩展Kubernetes/API扩展机制) —— 了解如何定义新的 Kubernetes 资源类型  
2. [API 聚合层（APIService）](/docs/cloud-native-ai/k8s/K8s学习-PartII-扩展Kubernetes/APIService) —— 理解聚合层工作原理与历史背景  
3. [自定义资源定义（CRD）](/docs/cloud-native-ai/k8s/K8s学习-PartII-扩展Kubernetes/CRD) —— 学习主流扩展方式与 OpenAPI 校验机制  
4. [控制器与 Operator 模式](/docs/cloud-native-ai/k8s/K8s学习-PartII-扩展Kubernetes/控制器与Operator模式) —— 掌握自定义控制循环的实现  
5. [Kubebuilder 实战](/docs/cloud-native-ai/k8s/K8s学习-PartII-扩展Kubernetes/Kubebuilder) —— 从零构建控制器  
6. [Operator SDK 实战](/docs/cloud-native-ai/k8s/K8s学习-PartII-扩展Kubernetes/Operator-SDK) —— 企业级 Operator 开发框架  
7. [准入控制扩展](/docs/cloud-native-ai/k8s/K8s学习-PartII-扩展Kubernetes/Admission-Webhook扩展) —— 掌握动态策略与安全校验  
8. [ValidatingWebhook](/docs/cloud-native-ai/k8s/K8s学习-PartII-扩展Kubernetes/Validating-Webhook扩展) 与 [MutatingWebhook](/docs/cloud-native-ai/k8s/K8s学习-PartII-扩展Kubernetes/Mutating-Webhook扩展) —— 实战示例  
9. [调度扩展机制](/docs/cloud-native-ai/k8s/K8s学习-PartII-扩展Kubernetes/调度架构扩展) —— 理解调度流程与 Framework  
10. [Scheduler Framework 插件](/docs/cloud-native-ai/k8s/K8s学习-PartII-扩展Kubernetes/Scheduler-Framework插件) —— 自定义调度逻辑  
11. [GPU 与 AI 调度](/docs/cloud-native-ai/k8s/K8s学习-PartII-扩展Kubernetes/GPU与AI调度) —— 面向 AI 原生场景的调度优化  
