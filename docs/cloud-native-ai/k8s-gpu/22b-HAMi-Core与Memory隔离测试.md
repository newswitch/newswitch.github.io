...
上一篇 [HAMi vGPU 原理与实践](./22-HAMi%20vGPU%20原理与实践.md) 介绍了安装与基本用法。本文对 **GPU Core / Memory 隔离**做实测验证。
...
1. 用 [GPU Operator](./09-NVIDIA%20GPU%20Operator%20架构与组件说明.md) 装好驱动 / Toolkit 等  
2. 按 [HAMi 原理与实践](./22-HAMi%20vGPU%20原理与实践.md) 安装 HAMi  
...
本文内容整理自 [意琦行 / KubeExplorer - 开源 vGPU 方案 HAMi: core&memory 隔离测试](https://www.cnblogs.com/KubeExplorer/p/18964975)，并按本系列学习路线做了结构调整与补充。前置阅读：[HAMi vGPU 原理与实践](./22-HAMi%20vGPU%20原理与实践.md)。
