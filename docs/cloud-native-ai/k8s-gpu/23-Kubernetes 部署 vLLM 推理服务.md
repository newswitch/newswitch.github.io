...
前置：[GPU Pod 配置](./07-Kubernetes%20GPU%20Pod%20配置详解.md)、[GPU Operator](./09-NVIDIA%20GPU%20Operator%20架构与组件说明.md)。显存规划见 [第 24 篇](./24-vLLM%20GPU%20显存组成与容量规划.md)，指标见 [第 28 篇](./28-大模型推理服务性能指标设计.md)。
...
| 主题 | 篇目 |
|------|------|
| 显存与 `gpu-memory-utilization` | [24](./24-vLLM%20GPU%20显存组成与容量规划.md) |
| Tensor Parallel 多卡 | [25](./25-vLLM%20Tensor%20Parallel%20多卡部署.md) |
| 探针精细设计 | [26](./26-大模型服务%20Kubernetes%20探针设计.md) |
| 滚动升级 / 优雅退出 | [27](./27-大模型推理服务滚动升级与优雅退出.md) |
| TTFT / KV / `/metrics` | [28](./28-大模型推理服务性能指标设计.md) |
| 队列与优先级 | [Volcano 16～18](./16-Volcano%20GPU%20调度器入门.md) |
