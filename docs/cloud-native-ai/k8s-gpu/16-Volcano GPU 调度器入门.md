...
本文整理自官方 [调度器介绍](https://volcano.sh/zh-hans/docs/scheduler/overview/) 与 [统一调度](https://volcano.sh/zh-hans/docs/v1.11.0/keyfeatures/unifiedscheduling/)，作为本系列 Volcano 三篇的总览。队列细节见 [Queue 与 GPU 配额](./17-Volcano%20Queue%20与%20GPU%20配额管理.md)，Gang 细节见 [Gang Scheduling](./18-Gang%20Scheduling%20在分布式训练中的作用.md)。
...
- [Volcano Queue 与 GPU 配额管理](./17-Volcano%20Queue%20与%20GPU%20配额管理.md)  
- [Gang Scheduling 在分布式训练中的作用](./18-Gang%20Scheduling%20在分布式训练中的作用.md)  
