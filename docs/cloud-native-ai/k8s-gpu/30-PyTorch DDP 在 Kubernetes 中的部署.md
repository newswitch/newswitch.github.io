...
本文把官方教程 [使用 DDP 进行多 GPU 训练](https://docs.pytorch.ac.cn/tutorials/beginner/ddp_series_multigpu.html) 里的改法，落到 **单机多卡 Pod** 与 **多机多卡 + Volcano Gang**。前置：[分布式训练基础](./29-Kubernetes%20分布式训练基础.md)、[Gang](./18-Gang%20Scheduling%20在分布式训练中的作用.md)、[Queue](./17-Volcano%20Queue%20与%20GPU%20配额管理.md)。
...
详见 [第 33 篇](./33-NCCL%20通信原理与常见问题.md)。
...
下一篇可选读 [ZeRO](./31-DeepSpeed%20ZeRO%20与%20GPU%20显存优化.md)；容错主线见 [Checkpoint](./32-训练任务%20Checkpoint%20与断点恢复.md)。
