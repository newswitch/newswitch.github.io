...
sidebar_label: "93. vLLM 学习笔记（三）：vLLM 调度器策略"
sidebar_position: 93
description: "本文代码基于 vLLM 0.6.3 V0，waiting/running/swapped 三队列及 Swap 调度不代表 V1。 当前统一 Token 调度主线请阅读 EngineCore 主循环与请求状态机。"
...
## 4. 初始化与请求队列管理 {/* #3-初始化与请求队列管理 */}

### 4.1 Scheduler 的初始化 {/* #31-scheduler-的初始化 */}
...
### 4.2 请求的预处理：解析并构建 SequenceGroup {/* #32-请求的预处理解析并构建-sequencegroup */}
...
### 6.2 优先级调度与抢占机制 {/* #52-优先级调度与抢占机制 */}
通过**优先级调度**与**抢占机制**保证高优先级请求优先获得资源。

#### 6.2.1 按优先级动态调整顺序 {/* #521-按优先级动态调整顺序 */}
