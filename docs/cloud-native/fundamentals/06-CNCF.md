...
### 5.2 TOC 成员选举 {/* #toc-成员选举 */}

TOC 成员通过社区选举产生，选举周期和流程详见 [GitHub TOC 仓库](https://github.com/cncf/toc)。

## 6. CNCF Ambassador 项目 {/* #cncf-ambassador-项目 */}

### 6.1 什么是 CNCF Ambassador {/* #什么是-cncf-ambassador */}
...
### 6.2 成为 Ambassador 的途径 {/* #成为-ambassador-的途径 */}
