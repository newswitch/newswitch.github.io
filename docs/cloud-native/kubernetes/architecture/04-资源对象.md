...
sidebar_label: "04. Kubernetes 中的资源对象"
sidebar_position: 4
...
## 1. Kubernetes 资源对象分类 {/* #kubernetes-资源对象分类 */}
...
## 9. 理解 Kubernetes 对象 {/* #理解-kubernetes-对象 */}
...
![Kubernetes 对象生命周期](/images/k8s/architecture/pod-state-and-lifecycle/5810af7b75ae6eb50221bedf332356c3.svg)
