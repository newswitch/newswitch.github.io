...
sidebar_label: "01. Kubernetes 的架构"
sidebar_position: 1
...
## 1. Kubernetes 的前身 Borg {/* #kubernetes-的前身-borg */}
...
![Borg 架构图](/images/k8s/architecture/overview/3482c70dd4d09f794748c5a93d539517.svg)

### 1.1 Borg 核心组件 {/* #borg-核心组件 */}
...
## 2. Kubernetes 架构总览 {/* #kubernetes-架构总览 */}
...
![Kubernetes 架构总览](/images/k8s/architecture/overview/a1a89650891fe65d7173653effe1ec82.svg)
...
![节点组件与 Pod 关系](/images/k8s/architecture/overview/4266a1401509a843bfb7ee758f729664.svg)
...
## 5. Kubernetes API 与对象模型 {/* #kubernetes-api-与对象模型 */}
...
![Kubernetes API 请求流程](/images/k8s/architecture/overview/f28e790438943eb2d9ad110d6f0eee98.svg)
...
![标签与选择器示例](/images/k8s/architecture/overview/3efaecfe88f1518f3c91ae43a80226c9.svg)
...
![命名空间资源隔离示意](/images/k8s/architecture/overview/256e34eafa44266a7ed019fd31298309.svg)
...
![对象所有权与级联删除](/images/k8s/architecture/overview/81b618988285148d04008ace255ff37f.svg)
...
## 8. API Server 工作机制 {/* #api-server-工作机制 */}

API Server 是控制面的核心，负责所有组件间通信与 API 暴露。

### 8.1 API Server 请求处理流程 {/* #api-server-请求处理流程 */}
...
![API Server 请求处理流程](/images/k8s/architecture/overview/c8c8f549dfbfd64e8b486ff88e7e23f6.svg)
...
### 8.2 Server-Side Apply {/* #server-side-apply */}
...
![Server-Side Apply 工作原理](/images/k8s/architecture/overview/03f8026feead4a6cccd0b17e50ef49dc.svg)
...
## 9. Kubernetes 扩展机制 {/* #kubernetes-扩展机制 */}
...
![Kubernetes 扩展点](/images/k8s/architecture/overview/5e3544b6d0aa3987b4ca85c2b5f791c3.svg)
...
![Kubernetes 指标采集流程](/images/k8s/architecture/overview/e4f92ef0fabb10ce42feec2a76fc7174.svg)
...
![Kubernetes 分布式追踪流程](/images/k8s/architecture/overview/fdf532a60038e6ace80c41d750e2b512.svg)
