...
sidebar_label: "01. Kubernetes 安全与访问控制概述"
sidebar_position: 1
...
## 1. Kubernetes 安全架构总览 {/* #kubernetes-安全架构总览 */}
...
![Kubernetes 安全架构分层](/images/k8s/security/overview/121d67c549545b8c53fd7d367ca93f62.svg)

## 2. 认证（Authentication） {/* #认证authentication */}
...
![Kubernetes 认证与访问控制流程](/images/k8s/security/overview/a05361f9ac2f66e663612be4229c8d8b.svg)

## 3. 鉴权（Authorization） {/* #鉴权authorization */}
...
![RBAC 组件关系](/images/k8s/security/overview/820e7d0c461aa99f308751d0bec739db.svg)

#### 3.2.1 RBAC 配置示例 {/* #rbac-配置示例 */}
...
## 4. 准入控制（Admission Control） {/* #准入控制admission-control */}
...
![API 请求准入控制流程](/images/k8s/security/overview/4470cb075382335647d75d233ff459fb.svg)
...
## 5. 数据加密（Data Encryption） {/* #数据加密data-encryption */}
...
![KMS 信封加密流程](/images/k8s/security/overview/5c21e87fcab6444db3b3040370dd7394.svg)

## 6. 证书管理 {/* #证书管理 */}

Kubernetes 广泛使用 X.509 证书进行认证。CSR API 支持自动化证书签发。

### 6.1 证书签名请求（CSR） {/* #证书签名请求csr */}
...
![证书签名请求流程](/images/k8s/security/overview/08f62257754b53bcfd36bd8ae395c096.svg)
...
![节点鉴权流程](/images/k8s/security/overview/e2b5a984360a23b3b46047823512bb55.svg)

### 8.2 kubelet 认证与授权 {/* #kubelet-认证与授权 */}
...
## 9. Kubernetes 安全最佳实践 {/* #kubernetes-安全最佳实践 */}
