...
sidebar_label: "02. Kubernetes 认证与鉴权"
sidebar_position: 2
...
![Kubernetes API 安全处理流程](/images/k8s/security/authn-and-authz/801cb980a749aa71a4a2f3a5cc462e06.svg)

## 2. 用户类型与身份来源 {/* #用户类型与身份来源 */}
...
![Kubernetes 用户身份来源](/images/k8s/security/authn-and-authz/5145a1edfcb3c8522e295f633f42d6e9.svg)

## 3. 认证机制（Authentication） {/* #认证机制authentication */}
...
![多认证模块短路流程](/images/k8s/security/authn-and-authz/e480392cebc83ca5e27bcf221cab57ee.svg)

### 3.2 典型认证方式说明 {/* #典型认证方式说明 */}
...
## 4. 鉴权机制（Authorization） {/* #鉴权机制authorization */}
...
![多鉴权器判定流程](/images/k8s/security/authn-and-authz/a9194330cb1883ebf281a609d755d159.svg)

## 5. RBAC 授权机制 {/* #rbac-授权机制 */}
...
![RBAC 对象关系](/images/k8s/security/authn-and-authz/7fd89242eca29d6231168fa9de22eb96.svg)
...
## 6. 准入控制（Admission Control） {/* #准入控制admission-control */}
...
![准入控制流程](/images/k8s/security/authn-and-authz/5887d76552c5efb30719f07a5fd6a7db.svg)
...
![Kubernetes 认证与鉴权全流程](/images/k8s/security/authn-and-authz/c56021059b28d622e75a2927fed611a3.svg)
