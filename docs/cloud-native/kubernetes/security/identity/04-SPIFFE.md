...
### 1.1 工作负载（Workload） {/* #工作负载workload */}
...
### 1.3 信任域（Trust Domain） {/* #信任域trust-domain */}
...
### 1.4 SPIFFE 可验证身份文件（SVID） {/* #spiffe-可验证身份文件svid */}
...
## 3. 信任包（Trust Bundle） {/* #信任包trust-bundle */}
