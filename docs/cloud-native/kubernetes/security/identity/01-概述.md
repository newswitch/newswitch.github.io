...
sidebar_label: "01. Kubernetes 身份与认证管理概述"
sidebar_position: 1
...
## 2. 基于角色的访问控制 (RBAC) {/* #基于角色的访问控制-rbac */}
...
![RBAC 组件关系图](/images/k8s/auth/overview/9a410ea713ed87d54df15fb1f071f172.svg)
...
## 4. SPIRE：SPIFFE 运行时环境 {/* #spirespiffe-运行时环境 */}
...
![SPIRE 架构图](/images/k8s/auth/overview/c1f23853d0d7494977caf36a273b05d7.svg)
...
## 5. Kubernetes 中的 SPIRE 集成 {/* #kubernetes-中的-spire-集成 */}
...
![SPIRE + Kubernetes 部署架构](/images/k8s/auth/overview/83f5b39d7c743a8951d113166fdf815c.svg)

## 6. RBAC 与 SPIFFE/SPIRE 的结合 {/* #rbac-与-spiffespire-的结合 */}
