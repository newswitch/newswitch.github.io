...
sidebar_label: "12. Kubernetes 设备插件（Device Plugin）深度剖析：异构资源调度的关键技术"
sidebar_position: 12
...
## 5. 动态资源分配（DRA）与设备插件 {/* #动态资源分配dra与设备插件 */}
...
![DRA 工作流程](/images/k8s/ai-native/k8s-device-plugin/4dad4a8ac6ac56ba025f7d44a8574595.svg)
