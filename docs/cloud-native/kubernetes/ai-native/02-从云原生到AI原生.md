...
![Kubernetes 扩展机制思维导图](/images/k8s/ai-native/from-cloud-native-to-ai-native/631304bb3d05d6491ade79b9259ddd28.svg)
...
## 2. 从 Cloud-Native 到 AI-Native 的演进 {/* #从-cloud-native-到-ai-native-的演进 */}
...
![从 Cloud-Native 到 AI-Native 演进时间线](/images/k8s/ai-native/from-cloud-native-to-ai-native/b9dc502a39611da76740a0bb222cc076.svg)

## 3. AI-Native 扩展模式的崛起 {/* #ai-native-扩展模式的崛起 */}

AI-Native 扩展模式正在重塑 Kubernetes 的应用边界。以下分别介绍三种典型模式。

### 3.1 AI Operator {/* #ai-operator */}
...
### 3.3 LLM Workflow Controller {/* #llm-workflow-controller */}
...
![AI-Native 扩展模式协同关系](/images/k8s/ai-native/from-cloud-native-to-ai-native/3ab6bed3797e6a46fafd9c53380edc5f.svg)

## 4. AI 原生调度的愿景 {/* #ai-原生调度的愿景 */}
...
![AI-Native Scheduler 发展方向](/images/k8s/ai-native/from-cloud-native-to-ai-native/547d941c44fe41c625ccd5b6fc81fa3a.svg)
