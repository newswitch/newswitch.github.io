...
sidebar_label: "13. Kubernetes AI 相关工作组介绍"
sidebar_position: 13
...
## 1. AI Native 三大工作组概览 {/* #ai-native-三大工作组概览 */}
...
## 2. WG AI Conformance：AI 工作负载能力基线 {/* #wg-ai-conformanceai-工作负载能力基线 */}
...
## 3. WG AI Gateway：AI 推理流量的网络治理模型 {/* #wg-ai-gatewayai-推理流量的网络治理模型 */}
...
## 4. WG AI Integration：AI 系统的 Kubernetes 集成体系 {/* #wg-ai-integrationai-系统的-kubernetes-集成体系 */}

该工作组聚焦于建立 AI 系统在 Kubernetes 上的生产级集成模式，涵盖模型、数据、算力、调度与运维等方面。

主要推进方向包括：

### 4.1 模型包标准：ModelPack（基于 OCI Artifact） {/* #模型包标准modelpack基于-oci-artifact */}

ModelPack 规范了模型在云原生环境中的结构、元数据、安全性、版本管理与供应链合规，确保模型在不同环境中具有可移植性与可审计性。

### 4.2 AI 框架的集成规范 {/* #ai-框架的集成规范 */}
