...
## 1. 引言：Kubernetes 的 AI 时代使命 {/* #引言kubernetes-的-ai-时代使命 */}
...
## 3. AI 基础设施的设计原则 {/* #ai-基础设施的设计原则 */}

AI 应用对底层基础设施提出了更高的要求，主要体现在计算密集、数据密集和网络密集三个方面。Kubernetes 需针对这些特性进行专项优化。

### 3.1 Kubernetes AI 架构设计原则 {/* #kubernetes-ai-架构设计原则 */}
...
## 10. 未来展望：AI 原生的 Kubernetes 复兴 {/* #未来展望ai-原生的-kubernetes-复兴 */}
