...
## 1. 什么是 AI Gateway {/* #什么是-ai-gateway */}
...
## 2. AI Gateway 架构设计 {/* #ai-gateway-架构设计 */}
...
## 3. Kubernetes 中的实现方式 {/* #kubernetes-中的实现方式 */}

在 Kubernetes 环境下，AI Gateway 可通过多种方式实现，满足不同场景需求。

### 3.1 Ingress Controller 实现 {/* #ingress-controller-实现 */}
...
### 3.2 Gateway API 实现 {/* #gateway-api-实现 */}
...
### 5.1 Envoy 作为 AI Gateway {/* #envoy-作为-ai-gateway */}
...
## 7. AI Gateway 最佳实践 {/* #ai-gateway-最佳实践 */}
