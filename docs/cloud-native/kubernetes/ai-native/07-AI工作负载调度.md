...
## 3. 资源预留与配额管理 {/* #资源预留与配额管理 */}

为保障 AI 任务的稳定运行，需合理配置资源预留和配额。

### 3.1 ResourceQuota 配置 {/* #resourcequota-配置 */}
...
### 3.2 LimitRange 配置 {/* #limitrange-配置 */}
...
### 4.1 KubeScheduler 扩展插件 {/* #kubescheduler-扩展插件 */}
...
4. [Kubernetes 批处理任务 - kubernetes.io](../controllers/06-Job.md)
