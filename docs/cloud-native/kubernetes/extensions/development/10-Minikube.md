...
### 6.1 安装 Minikube {/* #安装-minikube */}

#### 6.1.1 Homebrew 安装（推荐） {/* #homebrew-安装推荐 */}
...
### 6.2 安装 kubectl {/* #安装-kubectl */}

#### 6.2.1 Homebrew 安装（推荐） {/* #homebrew-安装推荐-1 */}
...
## 7. 启动与配置 Minikube {/* #启动与配置-minikube */}
