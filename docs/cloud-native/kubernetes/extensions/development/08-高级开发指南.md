...
![容器架构模式](/images/k8s/develop/advance-developer/d709b8364ab0ea2354b01fc0a1f00663.svg)

#### 2.1.1 Sidecar 容器模式 {/* #sidecar-容器模式 */}
...
### 2.2 Pod 配置高级实践 {/* #pod-配置高级实践 */}

合理配置亲和性、污点容忍和 Downward API，可提升调度效率和应用弹性。

#### 2.2.1 亲和性与反亲和性调度 {/* #亲和性与反亲和性调度 */}
...
#### 2.2.3 Downward API 生产实践 {/* #downward-api-生产实践 */}
...
### 2.3 高级工作负载控制器 {/* #高级工作负载控制器 */}

合理配置 HPA、CronJob 等控制器，实现自动扩缩容与定时任务调度。

#### 2.3.1 HorizontalPodAutoscaler (HPA) 增强配置 {/* #horizontalpodautoscaler-hpa-增强配置 */}
...
#### 2.3.2 CronJob 高级调度 {/* #cronjob-高级调度 */}
...
![多集群部署架构](/images/k8s/develop/advance-developer/1723554d93a7883484ac4992e8787b1f.svg)

#### 2.4.1 Karmada 多集群管理实践 {/* #karmada-多集群管理实践 */}
...
## 3. Kubernetes API 扩展模式 {/* #kubernetes-api-扩展模式 */}

Kubernetes 支持多种 API 扩展方式，满足复杂应用的自动化与智能化管理需求。

### 3.1 Operator 模式：智能自动化 {/* #operator-模式智能自动化 */}
...
![Operator 架构](/images/k8s/develop/advance-developer/9a366ffd4c629d7c84b4b9c54262773f.svg)
...
![Operator 开发工具栈](/images/k8s/develop/advance-developer/61ffb0e3346aad0c61f9679396bcfc14.svg)

### 3.2 CRD 最佳实践 {/* #crd-最佳实践 */}
...
![API 聚合层扩展](/images/k8s/develop/advance-developer/c9456d4d9f7733ed223b35bb6982af8d.svg)

## 4. 现代开发实践 {/* #现代开发实践 */}

现代云原生开发强调自动化、声明式配置和服务治理，以下介绍主流实践。

### 4.1 GitOps 工作流 {/* #gitops-工作流 */}
...
![GitOps 工作流](/images/k8s/develop/advance-developer/65a637e4da5c0f53a81b5cdc9a410148.svg)

#### 4.1.1 ArgoCD 应用管理 {/* #argocd-应用管理 */}
...
### 4.2 Service Mesh 集成 {/* #service-mesh-集成 */}
...
![服务网格架构](/images/k8s/develop/advance-developer/e9082c9a865bddea5bb1349109a35d2e.svg)

#### 4.2.1 Istio 服务治理 {/* #istio-服务治理 */}
...
### 4.3 Serverless 计算模式 {/* #serverless-计算模式 */}
...
![Knative 架构](/images/k8s/develop/advance-developer/1726af5e90ee2dfbe26cd39d09b2de33.svg)

#### 4.3.1 Knative 服务部署 {/* #knative-服务部署 */}
...
![可观测性架构](/images/k8s/develop/advance-developer/9c1346352fdf6b00868feef641002ad1.svg)

#### 5.1.1 Prometheus 监控配置 {/* #prometheus-监控配置 */}
...
![安全加固架构](/images/k8s/develop/advance-developer/d4be71a746b31d7e411fc15f56caee4a.svg)

#### 5.2.1 Pod 安全策略实施 {/* #pod-安全策略实施 */}
...
![灾难恢复与备份架构](/images/k8s/develop/advance-developer/f746e20ff2b4bb8385fec21b77472383.svg)

#### 5.3.1 Velero 备份配置 {/* #velero-备份配置 */}
