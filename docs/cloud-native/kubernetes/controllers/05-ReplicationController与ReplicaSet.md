...
### 2.2 与 ReplicationController 的区别 {/* #与-replicationcontroller-的区别 */}
...
## 4. ReplicaSet 配置示例 {/* #replicaset-配置示例 */}
...
### 5.1 创建 ReplicaSet {/* #创建-replicaset */}
...
### 5.2 查看 ReplicaSet 状态 {/* #查看-replicaset-状态 */}
...
### 5.4 删除 ReplicaSet {/* #删除-replicaset */}
...
- [Deployment 官方文档 - kubernetes.io](./02-Deployment.md)
