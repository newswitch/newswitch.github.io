...
sidebar_label: "10. 准入控制器（Admission Controller）"
sidebar_position: 10
...
![Kubernetes API 请求流程](/images/k8s/controllers/admission-controller/bb59bf9f845a2bea4c914597f61b3233.svg)
...
## 5. 与准入 Webhook 的关系 {/* #与准入-webhook-的关系 */}
...
![准入控制器执行顺序](/images/k8s/controllers/admission-controller/e6cabb9d9a7d6614ec221df2eaf600cf.svg)
