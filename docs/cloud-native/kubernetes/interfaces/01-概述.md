...
sidebar_label: "01. Kubernetes 中的开放接口"
sidebar_position: 1
...
### 1.1 容器运行时接口（CRI） {/* #容器运行时接口cri */}

- **功能**：提供计算资源管理
- **作用**：标准化容器运行时的交互方式
- **常见实现**：containerd、CRI-O、Docker Engine

### 1.2 容器网络接口（CNI） {/* #容器网络接口cni */}

- **功能**：提供网络资源管理
- **作用**：统一容器网络配置和管理
- **常见实现**：Flannel、Calico、Cilium、Weave Net

### 1.3 容器存储接口（CSI） {/* #容器存储接口csi */}
...
![Kubernetes 核心接口协作关系](/images/k8s/interfaces/overview/92d3003083d7d7924dd00c850782b279.svg)
