...
![kubeadm 生命周期流程](/images/k8s/operation/cluster-lifecyle-management/170fa3521edb579a131cba33e80f38f1.svg)
...
### 2.2 安装 kubeadm、kubelet 和 kubectl {/* #安装-kubeadmkubelet-和-kubectl */}
...
![kubeadm 组件安装流程](/images/k8s/operation/cluster-lifecyle-management/3e242dafa02d2c033f21cb077272f60e.svg)
...
### 2.4 使用 kubeadm init 创建集群 {/* #使用-kubeadm-init-创建集群 */}
...
![kubeadm init 工作流](/images/k8s/operation/cluster-lifecyle-management/41cf6c8909c2029f6bc4c69b100805ca.svg)
...
### 2.5 使用 kubeadm join 添加工作节点 {/* #使用-kubeadm-join-添加工作节点 */}
...
![工作节点加入流程](/images/k8s/operation/cluster-lifecyle-management/eceb5554f1e42bf8bfadaac2ab21a07f.svg)
...
![证书管理流程](/images/k8s/operation/cluster-lifecyle-management/66be1e6dad19163bb9f5d846a06505bf.svg)
...
![集群升级流程](/images/k8s/operation/cluster-lifecyle-management/64f3b576eefc4732c63396a1de275a4c.svg)

### 4.1 控制平面节点升级步骤 {/* #控制平面节点升级步骤 */}
...
![高可用集群拓扑](/images/k8s/operation/cluster-lifecyle-management/4a53ebf43e453b1f33a66d3469feba5e.svg)
...
### 6.1 API Server 不可用 {/* #api-server-不可用 */}
...
### 7.3 kubelet 配置自定义 {/* #kubelet-配置自定义 */}
