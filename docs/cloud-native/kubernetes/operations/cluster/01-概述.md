...
sidebar_label: "01. Kubernetes 集群运维与管理"
sidebar_position: 1
...
![Kubernetes 集群生命周期与关键工具](/images/k8s/operation/overview/5fe2cc0d294861b4af6dfff4e5dabd46.svg)

## 2. 使用 kubeadm 部署集群 {/* #使用-kubeadm-部署集群 */}
...
![kubeadm 集群创建流程](/images/k8s/operation/overview/0b4c30bb93a94ad67a15092d80040930.svg)
...
![kubeadm 集群升级流程](/images/k8s/operation/overview/093b3f9502944c3a72e6256822b433c7.svg)
...
![Kubernetes 版本发布与支持周期](/images/k8s/operation/overview/7f705a98c730e536df3ce2c27fd764cc.svg)
...
## 7. Windows 工作节点支持 {/* #windows-工作节点支持 */}

Kubernetes 支持在 Linux 控制平面下添加 Windows 工作节点，便于运行 Windows 工作负载。

### 7.1 添加 Windows 节点流程 {/* #添加-windows-节点流程 */}
