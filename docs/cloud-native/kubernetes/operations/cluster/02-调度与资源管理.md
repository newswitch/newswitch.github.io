...
sidebar_label: "02. Kubernetes 调度与资源管理"
sidebar_position: 2
...
![调度与资源管理核心组件](/images/k8s/operation/scheduling-and-resource-management/0b48a892565f7cc99148637858b25f76.svg)

## 2. Kubernetes 调度器原理 {/* #kubernetes-调度器原理 */}
...
![调度流程](/images/k8s/operation/scheduling-and-resource-management/4a336c158c21caae55e2d82bb47e737e.svg)

### 2.2 调度框架与插件机制 {/* #调度框架与插件机制 */}
...
![调度框架扩展点](/images/k8s/operation/scheduling-and-resource-management/fad38edf823ac0fb98b8b11ff3469623.svg)
...
### 3.2 Requests 与 Limits {/* #requests-与-limits */}
...
![Pod 资源请求与限制示意](/images/k8s/operation/scheduling-and-resource-management/97d371b394c2e5dca0e1607ceb0a294f.svg)
...
### 4.1 拓扑分布约束（Topology Spread Constraints） {/* #拓扑分布约束topology-spread-constraints */}
...
![拓扑分布约束示意](/images/k8s/operation/scheduling-and-resource-management/16f568d0cfe6ce9f423c95d2d649e8ae.svg)
...
### 4.2 污点与容忍（Taints & Tolerations） {/* #污点与容忍taints--tolerations */}
...
![污点与容忍调度示意](/images/k8s/operation/scheduling-and-resource-management/e8fca8cb32bd1b1c98a99fe07ccc755e.svg)
...
![Pod 优先级示意](/images/k8s/operation/scheduling-and-resource-management/e78caf0e1d15dd924aab8e9ddba408c0.svg)
...
![PDB 保护机制示意](/images/k8s/operation/scheduling-and-resource-management/f27af411de4700b90a5753f9cc319a4d.svg)

PDB 可指定 `minAvailable` 或 `maxUnavailable`，仅保护自愿中断，不防止节点故障或资源驱逐。

## 8. 自动扩缩容（Autoscaling） {/* #自动扩缩容autoscaling */}

Kubernetes 支持基于指标的自动扩缩容，提升资源利用率。

### 8.1 水平 Pod 自动扩缩容（HPA） {/* #水平-pod-自动扩缩容hpa */}
...
![HPA 工作流程](/images/k8s/operation/scheduling-and-resource-management/2156e4e4f5429e8cc0cea41478bd5386.svg)
...
## 9. 资源装箱（Bin Packing）策略 {/* #资源装箱bin-packing策略 */}

Kubernetes 支持多种资源装箱策略，提升集群利用率。

### 9.1 MostAllocated 策略 {/* #mostallocated-策略 */}
...
### 9.2 RequestedToCapacityRatio 策略 {/* #requestedtocapacityratio-策略 */}
...
![多调度器调度示意](/images/k8s/operation/scheduling-and-resource-management/6ed71126383050f86c1b8c4f5c9553c7.svg)

通过 Pod 的 `schedulerName` 字段指定调度器。

## 11. 集群规模与可扩展性 {/* #集群规模与可扩展性 */}
