...
sidebar_label: "01. Kubernetes 集群的访问方式概览"
sidebar_position: 1
...
![kubectl 到 API Server 的交互流程图](/images/k8s/access/overview/849c7c97a9ab438356726e99fc3199ac.svg)
...
![Kubernetes API 结构图](/images/k8s/access/overview/8d81cb2cdeb21f25953307d82f32e071.svg)
...
![kubectl 请求流程图](/images/k8s/access/overview/88f5994a3685293b38046cf27df03fb5.svg)

## 4. API Server 认证机制 {/* #api-server-认证机制 */}
...
![kubectl 认证流程图](/images/k8s/access/overview/54f43e41cebdf7ee3418a1285ba33292.svg)
...
## 8. kubectl 的 JSONPath 用法 {/* #kubectl-的-jsonpath-用法 */}
...
![Server-Side Apply 原理示意图](/images/k8s/access/overview/5e40387cf91c2a0ce6c0ffd5300747b3.svg)
...
### 10.2 API 代理与端口转发 {/* #api-代理与端口转发 */}

- 使用 `kubectl proxy` 创建本地代理
- 直接带认证访问 API Server
- 通过端口转发访问特定服务

## 11. kubectl 使用最佳实践 {/* #kubectl-使用最佳实践 */}
