...
sidebar_label: "08. k9s - Kubernetes 终端 UI"
sidebar_position: 8
...
![k9s 架构总览](/images/k8s/access/k9s/2111a4f035efb9cb345475e43d536ea2.svg)
...
![k9s 应用启动流程](/images/k8s/access/k9s/bfc9963dc7a09e7da3f9af5f22b0501f.svg)
...
![k9s 命令系统](/images/k8s/access/k9s/8af5ef630cb8c5473293bc60d888b164.svg)
...
![k9s 配置系统](/images/k8s/access/k9s/99d576beb8353499f4e79b42c2914306.svg)
...
![k9s 资源视图系统](/images/k8s/access/k9s/82219cc3b4ad3aa4d17e7f2ca1d1beb0.svg)
...
![k9s 数据访问层](/images/k8s/access/k9s/583dc7a8346f7096f8580971afa8f8e6.svg)
...
#### 5.1.2 从源码编译安装 {/* #从源码编译安装 */}

```bash
go install github.com/derailed/k9s@latest
```

#### 5.1.3 使用 kubectl krew 安装 {/* #使用-kubectl-krew-安装 */}
...
### 5.2 配置 kubeconfig {/* #配置-kubeconfig */}
...
![k9s 配置与定制](/images/k8s/access/k9s/a47a686835eadf5ed76a1bc426c26d22.svg)
