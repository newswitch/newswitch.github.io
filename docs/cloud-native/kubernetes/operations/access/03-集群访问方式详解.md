...
sidebar_label: "03. 访问 Kubernetes 集群的方式详解"
sidebar_position: 3
...
# 访问 Kubernetes 集群的方式详解

本文介绍了访问 Kubernetes 集群的各种方式，包括命令行工具、REST API、编程接口等多种方法。

## 1. 使用 kubectl 访问集群 {/* #使用-kubectl-访问集群 */}
...
### 2.2 直接访问（需要手动处理认证） {/* #直接访问需要手动处理认证 */}
...
### 4.3 在 Pod 中使用客户端库 {/* #在-pod-中使用客户端库 */}
