...
## 3. 创建应用程序和 Service {/* #创建应用程序和-service */}

通过以下步骤，完成应用部署与服务暴露。

### 3.1 步骤 1：创建 Deployment {/* #步骤-1创建-deployment */}
...
### 3.2 步骤 2：验证 Deployment {/* #步骤-2验证-deployment */}
...
### 3.3 步骤 3：创建 Service {/* #步骤-3创建-service */}
...
### 3.4 步骤 4：查看 Service 详情 {/* #步骤-4查看-service-详情 */}
...
### 3.5 步骤 5：查看 Pod 信息 {/* #步骤-5查看-pod-信息 */}
