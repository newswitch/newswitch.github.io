...
sidebar_label: "05. 使用 StatefulSet 部署有状态应用"
sidebar_position: 5
...
## 1. 何时使用 StatefulSet，何时使用 Operator {/* #何时使用-statefulset何时使用-operator */}
...
![StatefulSet Architecture Overview](/images/k8s/devops/using-statefulset/1d4549d05adba4d1377c46bd0bb4ccf2.svg)

## 3. 推荐的部署流程（高层） {/* #推荐的部署流程高层 */}
...
![Deployment Workflow](/images/k8s/devops/using-statefulset/67b6ca95d61b3f730a9fb7f4202f9e53.svg)

## 4. 精简示例：Headless Service + StatefulSet（最佳实践要素） {/* #精简示例headless-service--statefulset最佳实践要素 */}
...
![StatefulSet Rolling Update Sequence](/images/k8s/devops/using-statefulset/99d378c2886ad887509f1305fedaeb9d.svg)

## 5. 生产建议清单（要点速查） {/* #生产建议清单要点速查 */}
