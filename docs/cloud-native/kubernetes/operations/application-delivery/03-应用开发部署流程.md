...
sidebar_label: "03. 适用于 Kubernetes 的应用开发部署流程"
sidebar_position: 3
...
![End-to-End 发布架构](/images/k8s/devops/deploy-applications-in-kubernetes/1327ae365d5cfdf821401583f1945658.svg)
...
![本地开发工作流](/images/k8s/devops/deploy-applications-in-kubernetes/3f5ad138a016ae1725fe2fe8811e1740.svg)
...
![GitOps 工作流](/images/k8s/devops/deploy-applications-in-kubernetes/360e88e5d3d3f27c59218107322ea7af.svg)
...
## 7. 渐进式交付（Argo Rollouts） {/* #渐进式交付argo-rollouts */}
