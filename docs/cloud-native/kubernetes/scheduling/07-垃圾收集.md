...
## 1. Owner 和 Dependent 对象关系 {/* #owner-和-dependent-对象关系 */}
...
### 1.1 ownerReference 字段结构 {/* #ownerreference-字段结构 */}
...
### 1.2 自动设置 ownerReference {/* #自动设置-ownerreference */}
...
### 2.1 Background 级联删除 {/* #background-级联删除 */}
...
### 2.2 Foreground 级联删除 {/* #foreground-级联删除 */}
...
### 3.1 使用 kubectl 命令 {/* #使用-kubectl-命令 */}
...
### 4.1 blockOwnerDeletion 机制 {/* #blockownerdeletion-机制 */}
...
### 4.2 Finalizers 与垃圾收集 {/* #finalizers-与垃圾收集 */}
