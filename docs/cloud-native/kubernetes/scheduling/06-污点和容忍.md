...
sidebar_label: "06. Taint 和 Toleration（污点和容忍）"
sidebar_position: 6
...
## 2. Node Taint 管理 {/* #node-taint-管理 */}

通过命令行为节点添加、删除和查看污点，实现节点级的调度控制。

### 2.1 设置 Taint {/* #设置-taint */}
...
## 3. Pod Toleration 配置 {/* #pod-toleration-配置 */}
...
### 3.1 Toleration 字段说明 {/* #toleration-字段说明 */}
