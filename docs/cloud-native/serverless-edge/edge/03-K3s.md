...
sidebar_label: "03. K3s：轻量级 Kubernetes 发行版"
sidebar_position: 3
...
![K3s 集群架构示意图](/images/k8s/edge-computing/k3s/85bbe2de6995fc6561c22bf93cf238fe.svg)
...
![K3s 系统源码与组件流程](/images/k8s/edge-computing/k3s/4dd7aa7665896901ed7b08ae86772edf.svg)

## 4. 组件交互与运行机制 {/* #组件交互与运行机制 */}
...
![K3s 组件交互流程](/images/k8s/edge-computing/k3s/6e56fa5f77d7f3026602aa1691324746.svg)

## 5. 二进制架构与配置流程 {/* #二进制架构与配置流程 */}
...
![K3s 配置流程](/images/k8s/edge-computing/k3s/00f07a90c1ab3c7adf05be1c48927dde.svg)

## 6. 主要改进与组件特性 {/* #主要改进与组件特性 */}
