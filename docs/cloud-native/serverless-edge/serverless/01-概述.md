...
sidebar_label: "01. Kubernetes Serverless 架构概述"
sidebar_position: 1
...
![架构演进](/images/k8s/serverless/overview/dad6f6cba2ab5c6b48d7d7b0351c922d.svg)

### 1.2 Serverless 的核心特征 {/* #serverless-的核心特征 */}
...
## 2. Kubernetes 中的 Serverless 生态 {/* #kubernetes-中的-serverless-生态 */}
...
![Serverless 技术栈](/images/k8s/serverless/overview/1d2954963d744cb773fb0d899531eb1b.svg)
...
## 3. Serverless 架构的核心组件 {/* #serverless-架构的核心组件 */}

Serverless 架构由函数运行时、事件驱动架构和自动扩缩容系统等核心组件构成。

### 3.1 函数运行时（Function Runtime） {/* #函数运行时function-runtime */}
...
![函数生命周期和运行时特性](/images/k8s/serverless/overview/28f546c1b635fa77f46543b8dfeb7664.svg)

#### 3.1.1 冷启动问题与解决方案 {/* #冷启动问题与解决方案 */}
...
### 3.2 事件驱动架构（Event-Driven Architecture） {/* #事件驱动架构event-driven-architecture */}
...
![事件驱动架构](/images/k8s/serverless/overview/18fb4f086e5ef8bc04a6218f049b7748.svg)

#### 3.2.1 CloudEvents 标准 {/* #cloudevents-标准 */}
...
### 3.3 自动扩缩容系统（Auto-scaling） {/* #自动扩缩容系统auto-scaling */}
...
![自动扩缩容流程](/images/k8s/serverless/overview/7dab55485dd2d1713652281741bfb680.svg)

#### 3.3.1 HPA vs KEDA {/* #hpa-vs-keda */}
...
## 4. Serverless 与微服务的融合 {/* #serverless-与微服务的融合 */}
...
![微服务 vs Serverless](/images/k8s/serverless/overview/a265b3770c7fbae8e9c04d5688cdc516.svg)
...
![冷启动优化策略](/images/k8s/serverless/overview/ded9076c0951b5f98ab97a483e598079.svg)
...
### 6.1 Serverless 安全挑战与防护 {/* #serverless-安全挑战与防护 */}
...
![Serverless 安全挑战与防护](/images/k8s/serverless/overview/65e09dac1742b26e2e7769857007cfeb.svg)
...
![成本模型对比](/images/k8s/serverless/overview/cdd7ea2e3b122d00afbeb013a05f3d21.svg)
...
### 8.1 案例 1：电商平台订单处理 {/* #案例-1电商平台订单处理 */}
...
![电商订单处理](/images/k8s/serverless/overview/6791bf235116643389c0f7d458bc57c1.svg)

### 8.2 案例 2：实时数据处理 {/* #案例-2实时数据处理 */}
...
![实时数据处理](/images/k8s/serverless/overview/39dc6586a44b2f132ff5259340f27b73.svg)
