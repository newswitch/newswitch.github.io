...
sidebar_position: 2
description: "版本说明：官方任务 在集群中安装 DRA 要求 Kubernetes 服务器版本 不低于 v1.34（以你打开的文档页为准）。DRA 核心在 v1.35 起标为 stable；v1.36 仍有多项 Beta/Alpha。清单中的 apiVersion（如 resource.k8s.io/v1）……"
...
前置：[第 61 篇 概念](./01-Kubernetes%20DRA%20概念与核心%20API（v1.35+）.md)。工作负载分配步骤整理自 [使用 DRA 分配设备](https://kubernetes.io/zh-cn/docs/tasks/configure-pod-container/assign-resources/allocate-devices-dra/)。
