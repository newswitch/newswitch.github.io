...
sidebar_label: "02. PCIe总线学习（二）地址空间"
sidebar_position: 2
description: "前面已经说过，PCIe总线上的各组件以树形结构连接，其中树根是RC，树叶是EP，在RC和EP之间可以连接多级switch。由于PCIe可以通过switch来扩展这颗树，因而不同实例中，树的具体形状也会不同。"
tags: [PCIe, 总线, RDMA]
