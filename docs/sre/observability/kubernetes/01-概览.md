...
![可观测性三支柱](/images/k8s/observability/overview/9fd2affa6ae075204219672962404eac.svg)

#### 1.1.1 Metrics（指标） {/* #metrics指标 */}

- 系统指标：CPU、内存、磁盘、网络使用率
- 应用指标：响应时间、错误率、吞吐量
- 业务指标：用户活跃度、订单量、转化率

#### 1.1.2 Logs（日志） {/* #logs日志 */}

- 应用日志：业务逻辑执行记录
- 系统日志：操作系统和中间件日志
- 审计日志：安全和合规相关记录

#### 1.1.3 Traces（链路追踪） {/* #traces链路追踪 */}

- 分布式追踪：跨服务请求跟踪
- 性能分析：识别瓶颈和延迟源
- 错误关联：连接相关事件和错误

## 2. Kubernetes 可观测性架构 {/* #kubernetes-可观测性架构 */}
...
![Kubernetes 可观测性架构](/images/k8s/observability/overview/f53bcfade420485a6ae313122cc574c7.svg)

### 2.1 Kubernetes 原生可观测性 {/* #kubernetes-原生可观测性 */}

Kubernetes 提供了多种原生 API，便于基础观测和故障排查。

#### 2.1.1 Metrics API {/* #metrics-api */}
...
![分层观测策略](/images/k8s/observability/overview/68d303a8b176355bf34a6315c866495b.svg)
...
![CNCF 可观测性项目](/images/k8s/observability/overview/c957dd60fe6842097ba8c96228d09407.svg)
