...
![链路追踪与传统监控对比](/images/k8s/observability/tracing/aad460f5297a7e7ea53727a81bee07c6.svg)
...
![Span 结构](/images/k8s/observability/tracing/dc3924719762f263fae4651a5e0176cd.svg)

#### 1.2.2 Trace（链路） {/* #trace链路 */}
...
## 2. Jaeger 分布式追踪 {/* #jaeger-分布式追踪 */}

Jaeger 是 CNCF 毕业项目，广泛用于分布式链路追踪。

### 2.1 Jaeger 架构 {/* #jaeger-架构 */}
...
![Jaeger 架构总览](/images/k8s/observability/tracing/a2f49e6fa4fa43b190890f522dbf4724.svg)
...
## 3. OpenTelemetry 可观测性标准 {/* #opentelemetry-可观测性标准 */}

OpenTelemetry 是 CNCF 主推的可观测性标准，支持 Trace、Metrics、Logs 三大数据类型。

### 3.1 OpenTelemetry 架构 {/* #opentelemetry-架构 */}
...
![OpenTelemetry 架构](/images/k8s/observability/tracing/78955b3c0bb0fb625b4ce4532c0a5fe1.svg)
...
#### 3.3.2 Metrics 数据模型 {/* #metrics-数据模型 */}
