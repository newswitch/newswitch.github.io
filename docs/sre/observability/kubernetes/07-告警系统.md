...
![告警生命周期流程](/images/k8s/observability/alerting/8278944205a80664c94cb6201c345e67.svg)
...
## 2. Alertmanager 告警管理 {/* #alertmanager-告警管理 */}
...
![Alertmanager 架构与流程](/images/k8s/observability/alerting/daa14a54d8561cc779abc0f4d197e20c.svg)

### 2.3 核心概念 {/* #核心概念 */}

#### 2.3.1 告警路由（Routes） {/* #告警路由routes */}
...
#### 2.3.2 告警分组（Grouping） {/* #告警分组grouping */}
...
#### 2.3.3 告警抑制（Inhibition） {/* #告警抑制inhibition */}
...
#### 2.3.4 告警静默（Silences） {/* #告警静默silences */}
