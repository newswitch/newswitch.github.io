...
← [第 24 篇：Ceph 生产事故应急与复盘](../PartVII-生产优化/生产事故应急)
...
下一篇将讨论当 Ceph 扩大到数百/数千 OSD、数十亿对象和众多 Pool 后，如何控制 PG、MON/MGR、恢复、scrub、容量、网络和运维爆炸半径。

→ [第 26 篇：大规模 Ceph 集群设计与运维](../PartVII-生产优化/大规模Ceph集群优化)
