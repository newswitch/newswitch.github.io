...
上一篇建立了监控与排障方法，本篇把这套方法应用到 Ceph 最常见、也最容易误操作的场景：OSD 异常和物理磁盘更换。

← [第 14 篇：Ceph 监控告警](../PartV-日常运维与监控/Ceph监控告警)
...
下一篇将专门解释 PG 的各种组合状态，以及 inactive、stale、peering、degraded、inconsistent 和 unfound 应该如何分析。

→ [第 16 章：建立 Ceph 故障排查方法](./建立Ceph故障排查方法)
