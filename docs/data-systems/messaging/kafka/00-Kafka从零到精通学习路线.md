...
sidebar_position: 0
description: "从分区日志、Producer 与 Consumer 开始，深入 KRaft、部署、安全、协议源码、跨集群灾备、容量和生产验收。"
tags: [Kafka, KRaft, 消息队列, 流处理, 学习路线]
---

# Kafka 从零到精通学习路线

本路线把 Kafka 的分区日志、Producer、Consumer Group、复制、事务、容量和积压治理组织成一条学习主线，并纳入部署、安全、协议源码和跨集群灾备内容。
...
| 编号 | 文章 | 优先级 |
| --- | --- | --- |
| K00 | Kafka 从零到精通学习路线 | P0 |
| K01 | [Kafka 架构、分区日志、Segment 与索引](./01-Kafka架构分区日志Segment与索引.md) | P0 |
| K02 | [Producer Batching、Acks、重试与幂等](./02-Producer-Batching-Acks重试与幂等.md) | P0 |
| K03 | [Consumer Group、Offset、Rebalance 与顺序](./03-Consumer-Group-Offset-Rebalance与顺序.md) | P0 |
| K04 | [副本、ISR、Leader 选举与 KRaft](./04-副本ISR-Leader选举与KRaft.md) | P0 |
| K05 | [Kafka 事务与端到端 Exactly-Once](./05-Kafka事务与端到端Exactly-Once.md) | P1 |
| K06 | [Topic、Partition、磁盘、网络与容量规划](./06-Topic-Partition磁盘网络与容量规划.md) | P0 |
| K07 | [Kafka 积压、故障排查、滚动升级与 Kubernetes](./07-Kafka积压故障排查滚动升级与Kubernetes.md) | P1 |
| K08 | [KRaft 单机、分离角色集群、Docker 与 Kubernetes 部署](./08-Kafka-KRaft单机分离角色Docker与Kubernetes部署.md) | P0 |
| K09 | [TLS、SASL、ACL、配额与多租户安全](./09-Kafka-TLS-SASL-ACL配额与多租户安全.md) | P1 |
| K10 | [Network Thread、Request Handler、Replica Fetch 与源码路径](./10-Kafka网络线程请求处理副本拉取与源码路径.md) | P2 |
| K11 | [MirrorMaker 2、跨集群复制、灾备切换与一致性](./11-MirrorMaker2跨集群复制灾备切换与一致性.md) | P1 |
| K12 | [生产验收、监控告警、基准测试与故障演练](./12-Kafka生产验收监控基准与故障演练.md) | P1 |

命令实验使用 [Kafka Topic、Producer、Consumer 与 Group 命令手册](./13-Kafka-Topic-Producer-Consumer与Group命令手册.md)，与 K01～K12 的原理和生产实践配合学习。
...
5. K08～K12：掌握可复现部署、安全、源码、跨集群与验收。
