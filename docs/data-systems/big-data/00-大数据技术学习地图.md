...
这些路线分别补齐部署、内部数据路径、高可用、容量、恢复、安全、故障排查和源码，不改变本页原有 63 篇大数据主线的计数。
...
整套大数据路线当前收录 **63 篇**。其中 53 篇用于建立原理、架构、生产实践与综合项目，10 篇命令与实验手册用于把知识落实到查询、变更、验证和故障排查。命令手册不能替代原理文章，应在学完对应模块后用于动手验收。

| 阶段 | 模块 | 文章数 | 需要解决的问题 | 收录情况 |
|---|---:|---:|---|---|
| 第一阶段 | 学习地图、通用基础、端到端链路 | 7 | 先建立共同语言和全局视角 | 7 篇 |
| 第二阶段 | Hadoop / HDFS / YARN / Hive | 7 | 分布式文件、批处理、资源调度和元数据 | 7 篇 |
| 第三阶段 | Kafka | 7 | 分区日志、复制、消费、事务与积压治理 | 7 篇 |
| 第四阶段 | Spark | 7 | DAG、SQL、Shuffle、内存、流批和调优 | 7 篇 |
| 第五阶段 | Flink | 7 | 时间、状态、checkpoint、反压和升级恢复 | 7 篇 |
| 第六阶段 | 数据湖与 Iceberg | 5 | 表格式、快照、演进、小文件和多引擎 | 5 篇 |
| 第七阶段 | Trino 与 OLAP | 4 | MPP 查询、存储模型、选型和性能 | 4 篇 |
| 第八阶段 | 数据工程与治理 | 5 | CDC、编排、质量、治理和 SRE | 5 篇 |
| 第九阶段 | 综合项目 | 4 | 离线、实时、性能与 AI 数据生产 | 4 篇 |
| 第十阶段 | 命令与实验手册 | 10 | CLI、SQL、系统表、状态判断与安全操作 | 10 篇 |
| **合计** |  | **63** |  | **63 篇** |
