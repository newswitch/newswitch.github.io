...
### 8.1 第一步：确认语义与运行上下文 {/* #第一步确认语义与运行上下文 */}
...
### 8.2 第二步：看最终返回目标 {/* #第二步看最终返回目标 */}

返回几行、几列？是否真的需要全部大字段？排序和分页是否稳定？

### 8.3 第三步：从叶子看访问路径 {/* #第三步从叶子看访问路径 */}

每张表是点查、范围还是全扫描？扫描多少、返回多少？是否回表？

### 8.4 第四步：看行数如何逐层放大 {/* #第四步看行数如何逐层放大 */}
...
### 8.5 第五步：找估算和实际的分叉点 {/* #第五步找估算和实际的分叉点 */}

最早出现数量级误差的节点，往往比最外层“慢”节点更接近根因。

### 8.6 第六步：确认额外工作 {/* #第六步确认额外工作 */}
