...
容器 runtime 命令不重复写：[`crictl`](../../../../platform/kubernetes/commands/11-crictl命令详解.md)、[`ctr`](../../../../platform/kubernetes/commands/12-ctr命令详解.md)、[`nerdctl`](../../../../platform/kubernetes/commands/13-nerdctl命令详解.md)、[`docker`](../../../../platform/kubernetes/commands/14-docker命令详解.md)、[`podman`](../../../../platform/kubernetes/commands/15-podman命令详解.md)和[`runc`](../../../../platform/kubernetes/commands/16-runc命令详解.md)直接复用。网络 namespace 继续复用网络模块的 `ip netns`，挂载复用存储模块的 `findmnt/mount/umount`。
