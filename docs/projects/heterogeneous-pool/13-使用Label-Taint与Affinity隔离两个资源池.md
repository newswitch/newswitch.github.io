...
本站对照：[GPU 节点标签与调度](../../platform/gpu-cluster/scheduling-sharing/01-Kubernetes%20GPU%20节点标签与调度策略.md) · [Taint 与 Toleration](../../platform/gpu-cluster/scheduling-sharing/02-GPU%20节点%20Taint%20与%20Toleration%20实践.md)。
