...
本站对照：[大模型文件存储方案](../../foundations/storage/ai-workloads/06-大模型文件在%20Kubernetes%20中的存储方案.md) · [AI 存储 IO 模型](../../foundations/storage/ai-workloads/01-AI工作负载的存储IO模型.md) · [对象存储与模型仓库](../../foundations/storage/ai-workloads/04-对象存储与模型仓库设计.md)。
...
## 九～十一、PV / PVC / StorageClass、访问模式与 ReclaimPolicy
