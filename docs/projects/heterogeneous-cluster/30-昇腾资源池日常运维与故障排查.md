...
sidebar_label: "30. 30 · 昇腾池专项运维"
sidebar_position: 30
description: "系列：《NVIDIA＋昇腾双资源池 AI 推理集群：从 0 到部署、运维与故障排查》 阶段：第八阶段——运维与毕业 本文定位：昇腾池值班入口、设备健康、软件栈、参数面网络与维护 SOP 篇"
...
## 4. 五～六、日常巡检与读懂 npu-smi {/* #五六日常巡检与读懂-npu-smi */}
...
## 5. Device Plugin 故障 ConfigMap {/* #七device-plugin-故障-configmap */}
...
## 6. 八～十、Pending、容器看不见 NPU、版本不兼容 {/* #八十pending容器看不见-npu版本不兼容 */}
...
## 7. 主机 OOM 与 HBM OOM {/* #十一主机-oom-与-hbm-oom */}
...
## 9. 十三～十四、Unhealthy 与 npu-smi 卡住 {/* #十三十四unhealthy-与-npu-smi-卡住 */}
...
## 10. NPU Exporter {/* #十五npu-exporter */}
...
## 11. 十六～十七、隔离维护与成套升级 SOP {/* #十六十七隔离维护与成套升级-sop */}
...
## 12. 十八～二十、性能退化、证据包与值班决策树 {/* #十八二十性能退化证据包与值班决策树 */}
...
## 14. 二十二～二十三、巡检表与练习 {/* #二十二二十三巡检表与练习 */}
