...
sidebar_label: "15. 15 · 整卡、切分与共享"
sidebar_position: 15
description: "系列：《NVIDIA＋昇腾双资源池 AI 推理集群：从 0 到部署、运维与故障排查》 阶段：第四阶段——统一调度 本文定位：加速器分配模式、隔离能力与选型篇"
...
## 2. 整卡模式为什么仍然是生产基线 {/* #二整卡模式为什么仍然是生产基线 */}
...
## 3. 切分与共享是两类完全不同的技术 {/* #三切分与共享是两类完全不同的技术 */}
...
## 4. NVIDIA MIG 是什么 {/* #四nvidia-mig-是什么 */}
...
## 6. NVIDIA Time-Slicing 是什么 {/* #六nvidia-time-slicing-是什么 */}
...
## 7. MPS 为什么不能简单等同于 Time-Slicing {/* #七mps-为什么不能简单等同于-time-slicing */}
...
## 12. 如何选择：一套可执行的决策流程 {/* #十二如何选择一套可执行的决策流程 */}
