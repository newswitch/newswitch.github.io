...
sidebar_label: "21. 21 · 显存/HBM与启动参数"
sidebar_position: 21
description: "系列：《NVIDIA＋昇腾双资源池 AI 推理集群：从 0 到部署、运维与故障排查》 阶段：第六阶段——两套机器部署推理 本文定位：容量估算、启动参数设计与 OOM 排查篇"
...
对照：[vLLM 参数笔记](../../ai-systems/inference/vllm/96-vLLM学习笔记（六）参数使用.md) · [GPU 集群节点池规划](../../gpu/cluster/governance/01-生产%20GPU%20集群节点池规划.md)。
...
## 2. 显存和 HBM 中到底放了什么 {/* #二显存和-hbm-中到底放了什么 */}
...
## 6. Prefill 和 Decode 对容量的影响不同 {/* #六prefill-和-decode-对容量的影响不同 */}
...
## 9. NVIDIA 与昇腾的参数不能机械对抄 {/* #九nvidia-与昇腾的参数不能机械对抄 */}
...
## 12. OOM 时先判断发生在哪个阶段 {/* #十二oom-时先判断发生在哪个阶段 */}
...
## 13. Kubernetes 层的容量也要匹配 {/* #十三kubernetes-层的容量也要匹配 */}
...
## 16. 十六～十七、部署前验收与练习 {/* #十六十七部署前验收与练习 */}
