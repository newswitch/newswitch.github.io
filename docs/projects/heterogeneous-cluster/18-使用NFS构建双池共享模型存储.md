...
sidebar_label: "18. 18 · NFS双池共享模型存储"
sidebar_position: 18
description: "系列：《NVIDIA＋昇腾双资源池 AI 推理集群：从 0 到部署、运维与故障排查》 阶段：第五阶段——模型存储 本文定位：NFS 服务器、Kubernetes 挂载、性能验收与故障排查篇"
...
## 1. NFS 在双资源池中的位置 {/* #一nfs-在双资源池中的位置 */}
...
## 3. 生产 NFS 需要怎样的服务端 {/* #三生产-nfs-需要怎样的服务端 */}
...
## 5. 五～七、安装服务端、目录权限与 /etc/exports {/* #五七安装服务端目录权限与-etcexports */}
...
## 6. 八～十、防火墙、客户端与宿主机验证 {/* #八十防火墙客户端与宿主机验证 */}
...
## 11. 为什么模型加载可能拖垮 NFS {/* #十八为什么模型加载可能拖垮-nfs */}
...
## 14. 二十二～二十四、发布、备份与迁移 {/* #二十二二十四发布备份与迁移 */}
...
## 15. 二十五～二十六、验收清单与练习 {/* #二十五二十六验收清单与练习 */}
