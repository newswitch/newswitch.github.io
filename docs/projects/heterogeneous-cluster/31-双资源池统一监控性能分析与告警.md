...
## 十二～十四、设备/推理告警、分级与 Alertmanager
...
## 十九～二十一、Recording Rule、规则测试与监控自监控
...
下一篇是全系列毕业篇：从空白服务器完成双池部署、模型上线、网关、监控、压测、容灾演练与 SOP 验收。
...
- [附录 G：PromQL、告警与 Grafana 看板](./附录G-PromQL告警规则与Grafana看板清单.md)
