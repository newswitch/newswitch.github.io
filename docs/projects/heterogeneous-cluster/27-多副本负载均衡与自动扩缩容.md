...
sidebar_label: "27. 27 · 多副本负载均衡与扩缩容"
sidebar_position: 27
description: "系列：《NVIDIA＋昇腾双资源池 AI 推理集群：从 0 到部署、运维与故障排查》 阶段：第七阶段——生产服务 本文定位：推理副本、长连接负载均衡、HPA 自定义指标与容量保护篇"
...
## 2. 二～三、什么是一个副本；多副本解决什么 {/* #二三什么是一个副本多副本解决什么 */}
...
## 3. 四～五、Service 怎样分配流量；AI 负载均衡策略 {/* #四五service-怎样分配流量ai-负载均衡策略 */}
...
## 4. 六～七、vLLM 容量指标；什么适合触发扩容 {/* #六七vllm-容量指标什么适合触发扩容 */}
...
## 5. 八～九、HPA 自定义指标链路与示例 {/* #八九hpa-自定义指标链路与示例 */}
...
## 6. 十～十一、扩 Pod ≠ 扩设备；min/maxReplicas {/* #十十一扩-pod--扩设备minmaxreplicas */}
...
## 7. 十二～十四、冷启动、慢缩容与过载策略 {/* #十二十四冷启动慢缩容与过载策略 */}
...
## 8. 十五～十六、双池分别扩缩容；与发布冲突 {/* #十五十六双池分别扩缩容与发布冲突 */}
...
## 9. 十七～十八、压测验收与故障排查 {/* #十七十八压测验收与故障排查 */}
...
## 10. 十九～二十、生产检查表与练习 {/* #十九二十生产检查表与练习 */}
