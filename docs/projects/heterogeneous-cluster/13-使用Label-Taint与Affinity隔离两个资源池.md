...
sidebar_label: "13. 13 · Label、Taint与Affinity隔离"
sidebar_position: 13
description: "系列：《NVIDIA＋昇腾双资源池 AI 推理集群：从 0 到部署、运维与故障排查》 阶段：第四阶段——统一调度 本文定位：双资源池调度边界与基础隔离篇"
...
## 4. 给两个资源池添加 Taint {/* #四给两个资源池添加-taint */}
...
## 5. 为什么 Label 和 Taint 必须同时使用 {/* #五为什么-label-和-taint-必须同时使用 */}
...
## 6. NVIDIA 模型 Pod 的完整约束示例 {/* #六nvidia-模型-pod-的完整约束示例 */}
...
## 7. 昇腾模型 Pod 的完整约束示例 {/* #七昇腾模型-pod-的完整约束示例 */}
...
## 8. required 和 preferred 应该怎么选 {/* #八required-和-preferred-应该怎么选 */}
...
## 9. 系统 DaemonSet 如何进入加速器节点 {/* #九系统-daemonset-如何进入加速器节点 */}
...
## 10. 不要使用 nodeName 固定生产 Pod {/* #十不要使用-nodename-固定生产-pod */}
...
## 11. Namespace 不能替代节点隔离 {/* #十一namespace-不能替代节点隔离 */}
...
## 13. 必须进行的正向和反向测试 {/* #十三必须进行的正向和反向测试 */}
