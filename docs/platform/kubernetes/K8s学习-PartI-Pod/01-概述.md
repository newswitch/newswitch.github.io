...
| 控制器类型 | 用途 | 特点 |
|------------|------|------|
| [Deployment](../K8s学习-PartI-控制器/02-Deployment.md) | 无状态应用 | 副本管理、滚动更新 |
| [StatefulSet](../K8s学习-PartI-控制器/03-StatefulSet.md) | 有状态应用 | 有序部署、持久化存储 |
| [DaemonSet](../K8s学习-PartI-控制器/04-DaemonSet.md) | 节点级服务 | 每个节点运行一个 Pod |
| [Job](../K8s学习-PartI-控制器/06-Job.md) | 批处理任务 | 一次性任务执行 |
| [CronJob](../K8s学习-PartI-控制器/07-CronJob.md) | 定时任务 | 按计划执行任务 |
