...
概念对比见：[整卡 / Time-Slicing / MPS / MIG](./07-GPU%20整卡独占、Time-Slicing、MPS%20与%20MIG%20对比.md)。节点池隔离见：[标签](./01-Kubernetes%20GPU%20节点标签与调度策略.md)、[污点](./02-GPU%20节点%20Taint%20与%20Toleration%20实践.md)。
